...
func (c *checkServiceClient) Check(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*CheckResponse, error) {
	out := new(CheckResponse)
	err := c.cc.Invoke(ctx, "/check.v0.CheckService/Check", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedCheckServiceServer) Check(context.Context, *emptypb.Empty) (*CheckResponse, error) {
...
func _CheckService_Check_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/check.v0.CheckService/Check",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CheckServiceServer).Check(ctx, req.(*emptypb.Empty))
	}
...
var CheckService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "check.v0.CheckService",
